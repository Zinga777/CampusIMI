...
| Mutual profile reveals in chat (gender, interests, academic status, course stay hidden after a match; either side opts in per field, it only shows to both once both opt in) | ✅ Done |
